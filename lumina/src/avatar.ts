...
const eyes: Record<Emotion, string> = {
  NEUTRAL: `
    <!-- Left eye -->
    <ellipse cx="88" cy="120" rx="14" ry="10" fill="#1a0630"/>
    ...
    <!-- Right eye -->
    <ellipse cx="152" cy="120" rx="14" ry="10" fill="#1a0630"/>
  ...
  `,
  FELIZ: `
    <!-- Left eye happy - curved/squinted -->
    <ellipse cx="88" cy="120" rx="14" ry="12" fill="#1a0630"/>
    ...
    <!-- Right eye happy -->
    <ellipse cx="152" cy="120" rx="14" ry="12" fill="#1a0630"/>
  ...
  TRISTE: `
    <!-- Left eye sad - droopy -->
    <ellipse cx="88" cy="122" rx="13" ry="9" fill="#1a0630"/>
    ...
    <!-- Tear drop -->
    <ellipse cx="80" cy="135" rx="2" ry="3" fill="#4fc3f7" opacity="0.7"/>
    <!-- Right eye sad -->
    <ellipse cx="152" cy="122" rx="13" ry="9" fill="#1a0630"/>
    ...
    <ellipse cx="144" cy="135" rx="2" ry="3" fill="#4fc3f7" opacity="0.7"/>
  `,
  CURIOSA: `
    <!-- Left eye curious - normal -->
    <ellipse cx="88" cy="120" rx="13" ry="11" fill="#1a0630"/>
    ...
    <path d="M74 115 Q88 108 102 115" stroke="#c4a4e0" stroke-width="1.5" fill="none"/>
    <!-- Right eye curious - wider/raised -->
    <ellipse cx="152" cy="118" rx="15" ry="13" fill="#1a0630"/>
  ...
  `,
  SORPRENDIDA: `
    <!-- Left eye surprised - very wide -->
    <ellipse cx="88" cy="120" rx="16" ry="15" fill="#1a0630"/>
    ...
    <!-- Right eye surprised -->
    <ellipse cx="152" cy="120" rx="16" ry="15" fill="#1a0630"/>
  ...
  `,
  ENAMORADA: `
    <!-- Left eye love - heart shaped highlight -->
    <ellipse cx="88" cy="120" rx="14" ry="12" fill="#1a0630"/>
...
const eyebrows: Record<Emotion, string> = {
  NEUTRAL: `
    <path d="M76 103 Q88 98 100 103" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M140 103 Q152 98 164 103" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  `,
  FELIZ: `
    <path d="M76 101 Q88 95 100 101" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M140 101 Q152 95 164 101" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  `,
  TRISTE: `
    <path d="M76 106 Q88 102 100 104" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M140 104 Q152 102 164 106" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  `,
  CURIOSA: `
    <path d="M76 103 Q88 98 100 103" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M139 99 Q152 93 165 100" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  `,
  ENOJADA: `
    <path d="M76 108 Q88 103 100 105" stroke="#9d8ab0" stroke-width="3" fill="none" stroke-linecap="round"/>
    <path d="M140 105 Q152 103 164 108" stroke="#9d8ab0" stroke-width="3" fill="none" stroke-linecap="round"/>
  `,
  SORPRENDIDA: `
    <path d="M76 98 Q88 92 100 98" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M140 98 Q152 92 164 98" stroke="#9d8ab0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  `,
  ENAMORADA: `
    <path d="M76 101 Q88 95 100 101" stroke="#c48ab0" stroke-width="2" fill="none" stroke-linecap="round"/>
    <path d="M140 101 Q152 95 164 101" stroke="#c48ab0" stroke-width="2" fill="none" stroke-linecap="round"/>
  `,
};
...
const mouths: Record<Emotion, string> = {
  ...
  FELIZ: `
    <path d="M106 156 Q120 170 134 156" stroke="#c4a4e0" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M110 160 Q120 168 130 160" fill="rgba(180,120,200,0.2)" stroke="none"/>
  `,
  ...
  SORPRENDIDA: `
    <ellipse cx="120" cy="162" rx="10" ry="8" fill="rgba(100,50,150,0.4)" stroke="#c4a4e0" stroke-width="1.5"/>
  `,
  ENAMORADA: `
    <path d="M108 157 Q120 168 132 157" stroke="#f48fb1" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M113 161 Q120 167 127 161" fill="rgba(244,143,177,0.2)" stroke="none"/>
  `,
};
...
const cheeks: Record<Emotion, string> = {
  NEUTRAL: '',
  FELIZ: `
    <ellipse cx="70" cy="140" rx="14" ry="7" fill="rgba(255,150,180,0.18)"/>
    <ellipse cx="170" cy="140" rx="14" ry="7" fill="rgba(255,150,180,0.18)"/>
  `,
  TRISTE: `
    <ellipse cx="70" cy="138" rx="12" ry="6" fill="rgba(79,195,247,0.12)"/>
    <ellipse cx="170" cy="138" rx="12" ry="6" fill="rgba(79,195,247,0.12)"/>
  `,
  CURIOSA: `
    <ellipse cx="170" cy="138" rx="12" ry="6" fill="rgba(105,240,174,0.15)"/>
  `,
  ENOJADA: '',
  SORPRENDIDA: `
    <ellipse cx="70" cy="140" rx="13" ry="7" fill="rgba(206,147,216,0.18)"/>
    <ellipse cx="170" cy="140" rx="13" ry="7" fill="rgba(206,147,216,0.18)"/>
  `,
  ENAMORADA: `
    <ellipse cx="70" cy="138" rx="14" ry="7" fill="rgba(244,143,177,0.25)"/>
    <ellipse cx="170" cy="138" rx="14" ry="7" fill="rgba(244,143,177,0.25)"/>
  `,
};

export function buildAvatarSVG(emotion: Emotion, mini = false): string {
  const size = mini ? 80 : 220;
  const scale = mini ? 80 / 220 : 1;

  return `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 280" width="${size}" height="${size}" style="transform:scale(1)">
  <defs>
  ...
  <!-- Hair sides long -->
  <path d="M32 130 Q20 200 35 270 Q55 260 60 200 Q50 165 45 130 Z" fill="#1a0830"/>
  <path d="M208 130 Q220 200 205 270 Q185 260 180 200 Q190 165 195 130 Z" fill="#1a0830"/>
  <!-- Hair front strands -->
  ...
  <!-- Hair front overlay (covers top of face slightly) -->
  <ellipse cx="120" cy="68" rx="82" ry="45" fill="url(#hairGrad)"/>
  <!-- Side hair parting strand over face -->
  ...
  <path d="M50 270 Q70 245 120 240 Q170 245 190 270" fill="#2a1040" opacity="0.6"/>
</svg>`;
}
